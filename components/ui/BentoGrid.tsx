...
style={{
      ...
      >
      <div className={`${id===6} && felx-justify-center h-full`}>
            ...
            <div className={cn(
                  titelClassName, 'group-hover/'
                  )}>
                  <div className={cn(
                        'bento:translate-x-2 transition duration-200',
                        'relative md:h-full min-h-40 flex flex-col px-5',
                        'p-5 lg:p-10'
                  )}></div>
            </div>
      </div>
